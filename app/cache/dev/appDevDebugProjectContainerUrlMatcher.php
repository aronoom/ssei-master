...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (preg_match('#^/(?P<projet_id>[^/]++)/composante/(?P<comp_id>[^/]++)/activite/(?P<idActivite>[^/]++)/supprimer$#s', $pathinfo, $matches)) {
        ...
        if (preg_match('#^/(?P<projet_id>[^/]++)/composant/(?P<comp_id>[^/]++)/activite/(?P<act_id>[^/]++)/descriptif/modifier/(?P<idDescriptifParUi>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (preg_match('#^/(?P<idDescriptifProjet>[^/]++)/descriptif/modifier/(?P<idDescriptifParUi>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/projet')) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/objectifs/liste$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/objectifs/ajouter$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/objectifs/(?P<idObjectif>[^/]++)/modifier$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/objectifs/modifier$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/realisation/liste$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/realisation/ajouter$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/realisation/(?P<idRealisation>[^/]++)/modifier$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/projet/(?P<projet_id>[^/]++)/descriptifProjet/(?P<idDescriptifProjet>[^/]++)/situation_annuelle/(?P<idSituationAnnuelle>[^/]++)/realisation/supprimer$#s', $pathinfo, $matches)) {
        ...
        if (preg_match('#^/(?P<idActivite>[^/]++)/descriptif/(?P<idDescriptifParUi>[^/]++)/liste_situation_annuelle_descriptif_acitivite$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'projet_descriptif_activite_situation_annuelle_liste')), array (  '_controller' => 'ProjetBundle\\Controller\\SituationDescriptifActiviteController::listeAction',));
        }

        // projet_descriptif_activite_situation_annuelle_ajouter
        if (preg_match('#^/(?P<idActivite>[^/]++)/descriptif/(?P<idDescriptifParUi>[^/]++)/liste_situation_annuelle_descriptif_acitivite/ajouter$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'projet_descriptif_activite_situation_annuelle_ajouter')), array (  '_controller' => 'ProjetBundle\\Controller\\SituationDescriptifActiviteController::ajouterAction',));
        }

        // projet_descriptif_activite_situation_annuelle_modifier
        if (preg_match('#^/(?P<idActivite>[^/]++)/descriptif/(?P<idDescriptifParUi>[^/]++)/liste_situation_annuelle_descriptif_acitivite/(?P<idSituationAnnuelle>[^/]++)/modifier$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'projet_descriptif_activite_situation_annuelle_modifier')), array (  '_controller' => 'ProjetBundle\\Controller\\SituationDescriptifActiviteController::modifierAction',));
        }

        // projet_descriptif_activite_situation_annuelle_supprimer
        if (preg_match('#^/(?P<idActivite>[^/]++)/liste_situation_annuelle_descriptif_acitivite/supprimer$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'projet_descriptif_activite_situation_annuelle_supprimer')), array (  '_controller' => 'ProjetBundle\\Controller\\SituationDescriptifActiviteController::supprimerAction',));
        }
