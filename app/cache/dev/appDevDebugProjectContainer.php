...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'aretusa_flash_bundle.flash_messenger' => 'getAretusaFlashBundle_FlashMessengerService',
    ...
    /**
     * Gets the 'aretusa_flash_bundle.flash_messenger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Aretusa\Bundle\FlashBundle\Messenger\Flash A Aretusa\Bundle\FlashBundle\Messenger\Flash instance
     */
    protected function getAretusaFlashBundle_FlashMessengerService()
    {
        return $this->services['aretusa_flash_bundle.flash_messenger'] = new \Aretusa\Bundle\FlashBundle\Messenger\Flash($this->get('session'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Proc\UserBundle\Redirection\AfterLoginRedirection A Proc\UserBundle\Redirection\AfterLoginRedirection instance
     */
    protected function getAuthentication_Handler_LoginSuccessHandlerService()
    {
        return $this->services['authentication.handler.login_success_handler'] = new \Proc\UserBundle\Redirection\AfterLoginRedirection($this->get('router'), $this->get('security.authorization_checker'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'aretusa_flash_bundle.flash_messenger', 1 => 'onKernelResponse'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'procdb', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Proc/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Proc/IndicateurBundle/Entity'), 2 => ($this->targetDirs[3].'/src/ZoneBundle/Entity'), 3 => ($this->targetDirs[3].'/src/ProjetBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'Proc\\UserBundle\\Entity');
        $d->addDriver($c, 'Proc\\IndicateurBundle\\Entity');
        $d->addDriver($c, 'ZoneBundle\\Entity');
        $d->addDriver($c, 'ProjetBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'UserBundle' => 'Proc\\UserBundle\\Entity', 'IndicateurBundle' => 'Proc\\IndicateurBundle\\Entity', 'ZoneBundle' => 'ZoneBundle\\Entity', 'ProjetBundle' => 'ProjetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b2c5c9a2f62ea915f344989ffbe87ace07fd99cdd1fc4e48694e555069fc9ec1');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Proc\\UserBundle\\Entity\\Agent');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Proc\\UserBundle\\Entity\\Agent');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Proc\\UserBundle\\Entity\\Agent');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Proc/UserBundle/Resources/views'), 'FOSUser');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Proc/UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'/vendor/aretusa/flash-bundle/Aretusa/Bundle/FlashBundle/Resources/views'), 'AretusaFlash');
        $instance->addPath(($this->targetDirs[3].'/src/Proc/IndicateurBundle/Resources/views'), 'Indicateur');
        $instance->addPath(($this->targetDirs[3].'/src/ZoneBundle/Resources/views'), 'Zone');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1895c3059a14573a23aa63b6d989a77dd3877cca');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Proc/UserBundle/Resources/config/validation.yml')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'Proc\\UserBundle\\UserBundle',
                'AretusaFlashBundle' => 'Aretusa\\Bundle\\FlashBundle\\AretusaFlashBundle',
                'IndicateurBundle' => 'Proc\\IndicateurBundle\\IndicateurBundle',
                'ZoneBundle' => 'ZoneBundle\\ZoneBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'UserBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'/src/Proc/UserBundle'),
                    'namespace' => 'Proc\\UserBundle',
                ),
                'AretusaFlashBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/aretusa/flash-bundle/Aretusa/Bundle/FlashBundle'),
                    'namespace' => 'Aretusa\\Bundle\\FlashBundle',
                ),
                'IndicateurBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Proc/IndicateurBundle'),
                    'namespace' => 'Proc\\IndicateurBundle',
                ),
                'ZoneBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ZoneBundle'),
                    'namespace' => 'ZoneBundle',
                ),
                'ProjetBundle' => array(
                    'parent' => NULL,
            ...
            'kernel.secret' => '1895c3059a14573a23aa63b6d989a77dd3877cca',
            ...
            'fos_user.model.user.class' => 'Proc\\UserBundle\\Entity\\Agent',
