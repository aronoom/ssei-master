...
class Composante extends \ProjetBundle\Entity\Composante implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ProjetBundle\\Entity\\Composante' . "\0" . 'id', '' . "\0" . 'ProjetBundle\\Entity\\Composante' . "\0" . 'libelleComposante', '' . "\0" . 'ProjetBundle\\Entity\\Composante' . "\0" . 'projetId', '' . "\0" . 'ProjetBundle\\Entity\\Composante' . "\0" . 'projet', '' . "\0" . 'ProjetBundle\\Entity\\Composante' . "\0" . 'activites');
        }
