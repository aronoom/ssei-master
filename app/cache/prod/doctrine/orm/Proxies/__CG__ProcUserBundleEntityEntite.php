 ...
 */
class Entite extends \Proc\UserBundle\Entity\Entite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setCodeEntite($codeEntite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodeEntite', array($codeEntite));

        return parent::setCodeEntite($codeEntite);
    }
